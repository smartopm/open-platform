...
To avoid consuming alot more resources on development machine, we recomment development through ssh tunnel to a developer owned space on Digital Ocean

Reach for to your manager for setup and login credentials and follow the `DEV_PLAYBOOK.md` instructions
...
Gitlab requires to to authenticate using the gitlab token to be able to push code.
