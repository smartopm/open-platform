  ...
  it('records a new payment successfully', () => {
    cy.factory('community', { name: 'Nkwashi' }).then(commRes => {
      cy.factory('role', {
        ...
        cy.factory('permission', {
          module: 'plan_payment',
          permissions: ['can_see_menu_item', 'can_access_all_payments', 'can_create_plan_payment'],
          role_id: roleRes.body.id,
        })
        cy.factory('permission', {
          module: 'transaction',
          permissions: ['can_create_transaction', 'can_fetch_accounting_stats', 'can_fetch_transaction_summary'],
          role_id: roleRes.body.id,
        })
