  ...
  it('allows custodian to record time shift', () => {
    cy.factory('community', { name: 'Nkwashi' }).then((commRes) => {
      ...
      cy.factory('role', {
        ...
        cy.factory('permission', {
          module: 'timesheet',
          permissions: ['can_manage_shift', 'can_fetch_time_sheet_logs',
          'can_fetch_user_last_shift', 'can_see_menu_item',
           'can_fetch_user_time_sheet_logs', 'can_access_all_timesheets'],
