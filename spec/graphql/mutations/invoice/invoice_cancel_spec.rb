...
# # frozen_string_literal: true
# Note:- Invoice is curently not in use, we will modify the code based on future requirements.
...
#           expect(payment_plan.reload.pending_balance).to eql 200
...
#           expect(payment_plan.reload.pending_balance).to be_zero
...
#         before do
#           create_transaction(
#             user: user, amount: 200, source: 'cash', land_parcel_id: land_parcel.id, admin: admin,
#           )
#         end
