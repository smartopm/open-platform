...
# # frozen_string_literal: true
# Note:- Wallet Transaction is curently not in use, we will modify the code based on
# future requirements.
...
#           before do
#             create_transaction(
#               user: user, amount: 120, source: 'cash', land_parcel_id: land_parcel.id,
#               admin: admin,
#             )
#             create_transaction(
#               user: user, amount: 130, source: 'cash', land_parcel_id: land_parcel.id,
#               admin: admin,
#             )
#           end
...
#           before do
#             create_transaction(
#               user: user, amount: 100, source: 'cash', land_parcel_id: land_parcel.id,
#               admin: admin,
#             )
#           end
...
#           before do
#             create_transaction(
#               user: user, amount: 50, source: 'cash', land_parcel_id: land_parcel.id,
#               admin: admin,
#             )
#             create_transaction(
#               user: user, amount: 30, source: 'cash', land_parcel_id: land_parcel.id,
#               admin: admin,
#             )
#           end
