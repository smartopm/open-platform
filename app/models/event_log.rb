...
class EventLog < ApplicationRecord
  ...
  def execute_action_flows
    return unless execute_action_flow?
  ...
  # Verifies whether to execute action flow or not.
  # * If reference is autogenerated from action flows, returns false.
  # * Otherwise, true.
  #
  def execute_action_flow?
    return true if ref_type.nil?

    reference = ref_type.constantize.find_by(id: ref_id)
    !reference.try(:autogenerated)
  end
end
