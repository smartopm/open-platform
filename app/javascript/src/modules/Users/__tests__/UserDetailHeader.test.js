...
describe('User Detail Header Component', () => {
  ...
  it('should render render select menu list', () => {
    ...
    expect(container.queryByText('Merge User')).not.toBeInTheDocument();
    expect(container.queryByText('User Logs')).not.toBeInTheDocument();
    fireEvent.click(container.queryByText('Plans'));
    fireEvent.click(container.queryByText('Plots'));
    fireEvent.click(container.queryByText('Lead Management'));
    fireEvent.click(container.queryByText('Forms'));
    fireEvent.click(container.queryByText('Customer Journey'));
