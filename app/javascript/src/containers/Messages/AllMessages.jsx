  ...
  return (
    <PageWrapper>
      <div className={width > 1000 ? 'container' : 'container-fluid'}>
        <FormControl fullWidth>
          <InputLabel htmlFor="search-messages">
            {t('common:form_placeholders.message_search')}
          </InputLabel>
          <OutlinedInput
      ...
      <CenteredContent>
        ...
        >
          <InputLabel id="category-filter">
            {t('common:misc.filter_message_by_category')}
          </InputLabel>
          <Select
          ...
          <div className="d-flex justify-content-center">
            <nav aria-label="center Page navigation">
              <ul className="pagination">
                ...
                <li className={`page-item ${data.messages.length < limit && 'disabled'}`}>
