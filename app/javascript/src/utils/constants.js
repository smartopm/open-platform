...
export const industrySubSectorOptions = {
  ...
  plasticsPackagingMaterialsUnlaminatedFilmSheets:
  ...
  cosmeticsPerfumePersonalCareHouseholdProducts:
  ...
  aircraftEnginesOtherPartsAuxiliaryEquipment:
  ...
  officesOfPhysiciansDentistsOtherHealthcarePractitioners:
  ...
  accountingTaxPreparationBookkeepingPayrollServices:
  ...
  schoolsCollegesUniversitiesProfessionalSchools:
  ...
  pesticideFertilisersOtherAgriculturalChemicals:
    'Pesticide, fertilisers & other agricultural chemicals',
  outpatientCareCentresMedicalDiagnosticLaboratories:
